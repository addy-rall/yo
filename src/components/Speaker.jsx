...
const speakers = [
  ...
  },
  {
    ...
    img: nadiaImg,
    bio: "Gajendra Purohit (MSc, NET, PhD), known as GP Sir, has 20+ years of math teaching experience. He is a full-time YouTuber and is known for his engaging and insightful teaching methods. He founded MathsCare for online courses and GPS Publication House, with six bestselling books. Additionally, he is a motivational speaker and career guide.",
    color: '#e62b1e',
  ...
  },
  {
    ...
    role: 'Ex Agency Owner | Passionate Educator',
    img: image3,
    bio: "Sandeep Israni is Director & Partner at Varma Corp with 20+ years of experience in real estate sales, marketing, and customer strategy. An Economic Times Power of Ideas Awardee and TEDx speaker, he also serves as Adjunct Faculty at leading institutes including SCMHRD, Goa Institute of Management, and IIM Sambhalpur.",
    color: '#cf5096',
    instagram: 'https://www.instagram.com/sandeep.israni.re?igsh=cDl1NTR4ODBubnpz&utm_source=qr',
  },
  {
    id: '10',
    name: 'Mr. Manish Maheshwari',
    role: 'Market Educator | Trading Researcher | Finance Mentor',
    img: image4,
    bio: "Manish Maheshwari is a market educator, trading researcher, and finance mentor, known for building a structured and data-driven approach to trading education. A former software engineer, his journey into trading began during the COVID period, where early setbacks pushed him to deeply study market behavior and institutional activity. Today, he leads a growing trading education initiative focused on clarity, discipline, and real-market understanding, helping traders move beyond speculation to consistent execution. Through bootcamps, online learning, and community-driven discussions, he aims to develop responsible traders and future finance mentors across India.",
    color: '#2b7b22',
    instagram: 'https://www.instagram.com/manishmaheshwariunfiltered/',
  },
  {
    id: '11',
    name: 'Dr. Rakesh Varma',
    role: 'Ex IAS Officer | Motivator',
    img: rvImg,
    bio: "Dr. Rakesh Varma, Ex-IAS (VR), is an expert in Public Policy and Govt Affairs. He is an alumnus of National University of Singapore and the entrepreneur behind ESGmitra.",
    color: '#e62b1e',
    instagram: 'https://www.linkedin.com/in/dr-rakesh-varmaias',
    type: 'linkedin',
  },
  {
    id: '12',
    name: 'Mr. Tanmay Singhania',
    role: 'Author | Project Leader',
    img: tsImg,
    bio: "Tanmay Singhania is a Project Leader in data analytics and a fiction author who explores transformative journeys and inner awakening through his spiritual novels.",
    color: '#e62b1e',
    instagram: 'https://www.instagram.com/tanmaynawabofficial/',
    type: 'instagram',
  },
  {
    id: '13',
    name: 'Dr. Divyashree Nageswaran',
    role: 'Founder | Motivator',
    img: dnImg,
    bio: "Dr. Divyashree Nageswaran is a founder and entrepreneur with a PhD in Plant Sciences. She reflects on the courage it takes to unlearn intelligence and rebuild one's path.",
    color: '#e62b1e',
    instagram: 'https://www.instagram.com/divyashreenageswaran/',
    type: 'instagram',
  },
  {
    id: '14',
    ...
    img: imgl,
    bio: "Lokesh Patel is a self-made entrepreneur and technology leader working at the forefront of automation, robotics, and the Industrial Internet of Things (IIoT). With a degree in Electronics and Telecommunication, he began his entrepreneurial journey at the age of 24, building ventures from the ground up through technical expertise, resilience, and vision. Over the years, he has founded and led multiple organizations across software, automation, and advanced manufacturing, including URL Aseptic Automation Inc. and Autonomous Mechatronics Private Limited. His work spans industrial automation, machine vision systems, and pharmaceutical track-and-trace solutions that strengthen supply chain transparency and reduce counterfeiting risks. Lokesh has played a key role in delivering large-scale, compliance-driven technology solutions, particularly in regulated industries. His ability to integrate engineering, IT systems, and regulatory requirements has helped organizations implement efficient, scalable, and future-ready operations aligned with Industry 4.0. He is also an innovator with a patented virtual presence technology and several ongoing research initiatives. His approach combines deep technical knowledge with practical execution, enabling real-world impact through innovation. Beyond his professional work, Lokesh is actively involved in mentorship, philanthropy, and initiatives that connect technology with societal progress. He believes in using innovation not just to solve industrial challenges, but to create meaningful and lasting value for people and communities.",
    color: '#e62b1e',
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.header}>
        ...
        <h1 style={s.title}>
          THE <span style={{ color: '#e62b1e' }}>LINEUP</span>
        </h1>
      </div>
