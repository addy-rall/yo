...
const speakers = [
  { id: '01', name: 'Dr. Vijendra Chauhan', role: 'AI Researcher', org: 'IIT Delhi', img: arjunImg, bio: 'A pioneering researcher in ethical AI with 15+ years of experience at leading tech institutions.', color: '#e62b1e', instagram: 'https://www.instagram.com/masijeevi/' },
  { id: '02', name: 'Dr. Gajendra Purohit', role: 'Entrepreneur', org: 'FutureTech Labs', img: nadiaImg, bio: 'Serial entrepreneur and author. Mentored 8,000+ students through startup programmes.', color: '#e62b1e', instagram: 'https://www.instagram.com/dr.gajendrapurohit' },
  { id: '03', name: 'Dr. Yogeshwar Nath Mishra', role: 'Assistant Professor & Scientist at NASA', org: 'IIT Jodhpur', img: rahulImg, bio: 'Renowned for research on memory. TED talk has over 4 million views.', color: '#e62b1e', instagram: 'https://www.instagram.com/yogeshwar.space/' },
  { id: '04', name: 'Mr. Aditya Ranjan', role: 'Climate Activist', org: 'GreenFuture India', img: priyaImg, bio: 'Named one of Forbes 30 Under 30 for his environmental movement work.', color: '#e62b1e', instagram: 'https://www.instagram.com/aditya___ranjan/' },
  { id: '05', name: 'Mr. Deepak Wadhwa', role: 'Innovator', org: 'Org 5', img: image1, bio: 'Leading breakthroughs in sustainable energy and modular design.', color: '#e62b1e', instagram: 'https://www.instagram.com/thedeeptalks.official/' },
  { id: '06', name: 'Mr. Kiran Kumar', role: 'Tech Evangelist', org: 'Org 6', img: imagk, bio: 'Specialist in decentralized networks and the future of digital identity.', color: '#e62b1e', instagram: 'https://www.instagram.com/kiran_sidde/' },
  { id: '07', name: 'Mr. Debojit Sen', role: 'Founder & CEO, Crack-ED', org: 'Crack-ED', img: kyu, bio: "Founder & CEO of Crack-ED, building job-ready education at scale. Backed by CarDekho Group, recipient of BW Disrupt 40 Under 40 Award.", color: '#e62b1e', instagram: null },
];
